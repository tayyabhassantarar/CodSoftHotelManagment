                    ...
                    <div class="grid col-12">
                        <div class="row">
                            <div class="col-10">
                                <table id="carHireTable">
                                    ...
                                    <tbody>
                                        ...
                                        // Fetch data from the car_hire table
                                        $sql = "SELECT * FROM car_hire";
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>" . $row["available_cars"] . "</td>";
                                                echo "</tr>";
                                            }
                                        } else {
                                            echo "<tr><td colspan='7'>No car hires found.</td></tr>";
                                        }
                            ...
                            <div class="submit_b col-2">
                                ...
                                <a href="car_hire.php" class="display_button btn btn-primary " role="button">Return</a>
